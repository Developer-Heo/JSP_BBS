	...
	<div class="container">
		<div class="jumbotron">
			<div class="contatiner">
				<h1>웹 사이트 소개</h1>
				<p>
					이 웹 사이트는 부트스트랩으로 만든 JSP 웹 사이트 입니다.<br>이어서 스프링 게시판 만들기도 계획하고 있습니다.
				</p>
				<p>
					<a class="btn btn-primary btn-pull" href="http://github.com/Developer-Heo" roll="button">만든이 Github링크</a>
				</p>
			</div>
		</div>
	</div>
